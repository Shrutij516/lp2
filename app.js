...
// const url = 'mongodb+srv://shrutijagdale16:user123@cluster0.1ygqnyd.mongodb.net/?retryWrites=true&w=majority'
const url = 'mongodb+srv://shrutijagdale16:user123@cluster0.1ygqnyd.mongodb.net/?retryWrites=true&w=majority'
const port = 3000;
...
server.post('/addSongs', async (req, res)=> {
    try {
        ...
        musicModel.insertMany(songList)
...
server.delete('/deleteSongs/:name', async (req, res)=> {
    try{
